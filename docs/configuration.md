...
**Important**: Validation still runs for auto-generated links. If `docs/reference/cli.md` doesn't exist, docsync will report an error. Only staleness checks are skipped.

When auto-generated docs are skipped, docsync reports the count:
